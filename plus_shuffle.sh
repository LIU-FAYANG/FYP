...
for CL_steps in "${values[@]}"; do
    ...
    distill_teacher=plus_shuffle/prob$group_size_by_prob-seed$seed-warmup_steps$CL_steps-distillation_stopping_steps$distillation_stopping_steps
