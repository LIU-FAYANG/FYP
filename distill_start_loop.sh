...
seed=2023
values=("6225" "6725" "7225" "7725" "7725" "8225")
distillation_stopping_steps=12000
...
for CL_steps in "${values[@]}"; do
    ...
    distill_teacher=expriment2/1224morning_warmup_seed$seed-warmup_steps$CL_steps-distillation_stopping_steps$distillation_stopping_steps
